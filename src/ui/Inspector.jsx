      ...
      <Section title="생산" data-guide="panel-production">
        ...
        <div className="mt-3">
          ...
          {/**
            * **흔들림의 모양.**
            * -----------------------------------------------------------------
            *  같은 ± 라도 모양에 따라 라인이 다르게 돈다. **재 본 값**은 이렇다
            *  (버퍼 8칸, 30분 × 20판) — 자세한 표는 `core/random.js`.
            *
            *      고르게 막힘 79초 · 가운데로 58 · 가끔 길게 55 · 최소·보통·최대 45
            *
            *  **막힘은 꼬리가 아니라 흔들림의 크기를 따라간다** — 같은 ± 면 균등이
            *  제일 크게 흔들린다. 꼬리는 「한 개가 얼마나 늦을 수 있나」에 나타난다
            *  (균등 1.50배가 천장 · 로그정규 2.68배). 안전 재고와 납기에서 갈린다.
            *
