...
export const GUIDES = [
...

  {
    ...
    steps: [
      ...
      {
        id: 'slots',
        title: '적치대 자리를 종류별로 나누기',
        body: '적치대를 고르고 **자리 나누기**에서 종류마다 몇 자리를 줄지 정하세요.\n안 나누면 한 종류가 다 차지해 **교착**이 납니다 — 서로가 서로를 기다립니다.',
        spot: ['[data-guide="panel-slots"]'],
        done: (f) => f.stillageSlots,
      },
    ],
  },

  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: '**역할** 칸에서 선반마다 **싣기/내리기**를 정할 수 있습니다.\n안 정하면 가까운 쪽 띠를 따릅니다 — 같은 선반이라도 카트마다 하는 일이 다를 수 있습니다.',
        spot: ['[data-guide="panel-cart"]'],
        done: (f) => f.cartRoles,
      },
      {
...

  {
    id: 'share',
    title: '나눠 쓰기',
    blurb: '도면을 파일로 꺼내기 · 링크로 공유 · 공용 도면 열기',
    steps: [
      {
        id: 'export',
        title: '파일로 꺼내 두기',
      ...
      },
      {
        id: 'upload',
        title: '내 도면 올리기',
        body: '**공유** 를 누르고 이름과 설명을 적으면 링크가 나오고 **공용 도면 목록**에도 올라갑니다.\n링크를 가진 사람은 **누구나** 열 수 있습니다 — 회사 도면이면 다시 생각해 주세요.',
        spot: ['[data-guide="btn-share"]'],
        done: () => false,
        optional: true,
      },
    ],
